...
function pixelPainterGenerator(){
    document.querySelector('#PIXEL-PAINTER').innerHTML = `
    <div class="pixel-title">
    <h2>pixel-painter</h2>
</div>
<div class="pixel-option">
    <div class="option-slider">
        <label for="resolution-range">Grid resolution</label>
        <input id="resolution-range" type="range" min="4" max="24" value="24">
        <span id="resolution-value">00</span>
    </div>
...
function newPixels(resol) {
    ...
    pixelEventListener(); // 새로 생긴 pixel들에 이벤트 리스너 적용
}
